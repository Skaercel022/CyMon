...
void effect_status(Pokemon* poke, int* nbtour, SDL_Renderer* rend);
...
Comp choix_atk(Pokemon* bu, SDL_Renderer* rend);
int attaque_esquivee(Comp atk, Pokemon* attaque, Pokemon* defend);
float degats(Pokemon* attaquant, Pokemon* defenseur, Comp atq);
void effet_spe(Pokemon** attaquant, Pokemon* defenseur, Comp atk, SDL_Renderer* rend);
...
void fin_e_a_b(Pokemon* offense, Pokemon* cible, Comp choix, SDL_Renderer* rend);
void effect_atk_bot(Pokemon* offense, Pokemon** team, Pokemon** adversaires, SDL_Renderer* rend);
Pokemon* choix_target(Pokemon** team, Pokemon** opp, SDL_Renderer* rend);
void fin_e_a(Pokemon* offense, Pokemon* cible, Comp atk, SDL_Renderer* rend);
void effect_atk(Pokemon* offense, Pokemon** team, Pokemon** adversaires, Comp atk, SDL_Renderer* rend);
